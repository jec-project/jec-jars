...
// Utilities:
import * as utils from "../../../../../utils/test-utils/utilities/ExitTestUtils";
...
describe("Exit", ()=> {
  ...
  before(()=> {
    ...
    annotationSpy = sinon.spy(ExitAnnotation, "Exit");
  ...
  describe("@Exit", ()=> {
    ...
    it("should invoke the JcadContextManager with the JarsConnectorRefs.EXIT_CONNECTOR_REF reference", function() {
      ...
      sinon.assert.calledWith(
        getContextSpy, JarsConnectorRefs.EXIT_CONNECTOR_REF
      );
    });
    ...
    it("should invoke the DecoratorConnectorManager with the JarsConnectorRefs.EXIT_CONNECTOR_REF reference and the correct JCAD context", function() {
      ...
      sinon.assert.calledWith(
        getDecoratorSpy, JarsConnectorRefs.EXIT_CONNECTOR_REF, context
      );
    });
