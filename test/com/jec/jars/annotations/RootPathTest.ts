...
describe("RootPath", ()=> {
  ...
  before(()=> {
    ...
    connector = new TestConnector(JarsConnectorRefs.ROOT_PATH_CONNECTOR_REF, TEST_DECORATOR);
    context = factory.create();
    CTXM.addContext(JarsConnectorRefs.ROOT_PATH_CONNECTOR_REF, context);
    DCM.addConnector(connector, context);
  });

  after(()=> {
    CTXM.removeContext(JarsConnectorRefs.ROOT_PATH_CONNECTOR_REF);
    DCM.removeConnector(JarsConnectorRefs.ROOT_PATH_CONNECTOR_REF, context);
    connector = null;
    context = null;
  });
