...
// Utilities:
import * as utils from "../../../../../utils/test-utils/utilities/QueryParamTestUtils";
...
describe("QueryParam", ()=> {
  ...
  before(()=> {
    ...
    annotationSpy = sinon.spy(QueryParamAnnotation, "QueryParam");
  ...
  describe("@QueryParam", ()=> {
    ...
    it("should invoke the JcadContextManager with the JarsConnectorRefs.QUERY_PARAM_CONNECTOR_REF reference", function() {
      ...
      sinon.assert.calledWith(
        getContextSpy, JarsConnectorRefs.QUERY_PARAM_CONNECTOR_REF
      );
    });
    ...
    it("should invoke the DecoratorConnectorManager with the JarsConnectorRefs.QUERY_PARAM_CONNECTOR_REF reference and the correct JCAD context", function() {
      ...
      sinon.assert.calledWith(
        getDecoratorSpy, JarsConnectorRefs.QUERY_PARAM_CONNECTOR_REF, context
      );
    });
