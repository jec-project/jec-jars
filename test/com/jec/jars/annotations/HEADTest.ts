...
// Utilities:
import * as utils from "../../../../../utils/test-utils/utilities/HEADTestUtils";
...
describe("HEAD", ()=> {
  ...
  before(()=> {
    ...
    annotationSpy = sinon.spy(HEADAnnotation, "HEAD");
  ...
  describe("@HEAD", ()=> {
    ...
    it("should invoke the JcadContextManager with the JarsConnectorRefs.HEAD_CONNECTOR_REF reference", function() {
      ...
      sinon.assert.calledWith(
        getContextSpy, JarsConnectorRefs.HEAD_CONNECTOR_REF
      );
    });
    ...
    it("should invoke the DecoratorConnectorManager with the JarsConnectorRefs.HEAD_CONNECTOR_REF reference and the correct JCAD context", function() {
      ...
      sinon.assert.calledWith(
        getDecoratorSpy, JarsConnectorRefs.HEAD_CONNECTOR_REF, context
      );
    });
