...
/**
 * The <code>@PathParam</code> decorator defines a type of parameter that you  
 * can extract for use in your resource class. URI path parameters are extracted 
 ...
 */
export function PathParam(target:any, propertyKey:string | symbol,
