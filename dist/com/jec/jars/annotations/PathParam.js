...
function PathParam(target, propertyKey, parameterIndex) {
    const ctx = CTXM.getContext(JarsConnectorRefs_1.JarsConnectorRefs.PATH_PARAM_CONNECTOR_REF);
    DCM.getDecorator(JarsConnectorRefs_1.JarsConnectorRefs.PATH_PARAM_CONNECTOR_REF, ctx)
