...
function GET(params) {
    return function (target, key, descriptor) {
        const ctx = CTXM.getContext(JarsConnectorRefs_1.JarsConnectorRefs.GET_CONNECTOR_REF);
        return DCM.getDecorator(JarsConnectorRefs_1.JarsConnectorRefs.GET_CONNECTOR_REF, ctx)
