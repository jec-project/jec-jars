...
function RequestParam(target, propertyKey, parameterIndex) {
    const ctx = CTXM.getContext(JarsConnectorRefs_1.JarsConnectorRefs.REQUEST_PARAM_CONNECTOR_REF);
    DCM.getDecorator(JarsConnectorRefs_1.JarsConnectorRefs.REQUEST_PARAM_CONNECTOR_REF, ctx)
