...
function Init() {
    return function (target, key, descriptor) {
        const ctx = CTXM.getContext(JarsConnectorRefs_1.JarsConnectorRefs.INIT_CONNECTOR_REF);
        return DCM.getDecorator(JarsConnectorRefs_1.JarsConnectorRefs.INIT_CONNECTOR_REF, ctx)
