...
function HEAD(params) {
    return function (target, key, descriptor) {
        const ctx = CTXM.getContext(JarsConnectorRefs_1.JarsConnectorRefs.HEAD_CONNECTOR_REF);
        return DCM.getDecorator(JarsConnectorRefs_1.JarsConnectorRefs.HEAD_CONNECTOR_REF, ctx)
